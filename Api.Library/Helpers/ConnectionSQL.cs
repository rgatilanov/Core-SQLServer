...
namespace Api.Library.Helpers.Data
{
    public class ConnectionSQL : IDisposable
    {
        ...
        public ConnectionSQL AutoDesconexion { get; set; }

        public static ConnectionSQL Conectar(string ConnectionString)
        {
